...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { nome: @funcionario.nome, papel: @funcionario.papel, password: @funcionario.password, password_confirmation: @funcionario.password_confirmation, usuario: @funcionario.usuario } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { nome: @funcionario.nome, papel: @funcionario.papel, password: @funcionario.password, password_confirmation: @funcionario.password_confirmation, usuario: @funcionario.usuario } }
